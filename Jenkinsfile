        ...
        stage('Release to Octopus') {
            steps {
                script {
                    ...
                    bat """
                    ${env.OCTO_CLI} create-release --project MyWebApp --releaseNumber 1.0.${BUILD_VERSION} --deployTo Production --server http://localhost:8082 --apiKey API-GYVWJTOVGSV7SLJE6BYFZVM8XKPLDDCN
                    """
                }
            }
        }
